            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex gap-3">
                  ...
                  <button 
                    onClick={() => navigate('/simple-questions')}
                    className="px-4 py-2 bg-[#34D399] text-white rounded-lg text-sm hover:bg-[#10B981] transition-colors flex items-center gap-2"
                  >
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
